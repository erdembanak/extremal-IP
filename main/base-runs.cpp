...
/*
	{
		...
		ofstream MyFile("depth_default_7_8_no_time.txt", std::ios_base::app);

		MyFile << depth << "," << arrayRemove0.size() << "," << arrayRemove1.size() << endl;
		MyFile.close();
	}
...
//		ofstream MyFile("depth_orbital_9_11.txt", std::ios_base::app);
		ofstream MyFile("deneme.txt", std::ios_base::app);

		MyFile << depth << "," << secs << "," << branch_on.size() << "," << arrayRemove0.size() << "," << arrayRemove1.size() << endl;
		MyFile.close();
	}
...
void solve(int d, int max_match){
	...
	ofstream MyFile("results_orbit_v2_depth_custom.txt", std::ios_base::app);
...
int main() {
	...
	//ofstream MyFile("results_orbit_v2_depth_custom.txt");
	//MyFile << "d,N,LB,UB,time,nodeCount \n";
	//MyFile.close();

//	ofstream MyFile("depth_orbital_10_11.txt");
//	MyFile << "depth, Nautymiliseconds, orbitSize, var0, var1 \n";
//	MyFile << "depth, var0, var1 \n";
